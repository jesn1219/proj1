...
extern unsigned long long buf_dblwr_init_or_load_pages_time, buf_dblwr_init_or_load_pages_count;
...
@retval 0 always */
// jesnk : AT innodb_shutdown
static int innodb_shutdown(handlerton *, ha_panic_function) {
  DBUG_ENTER("innodb_shutdown");

  // jesnk : Codes for printing time profile of buf_dblwr_init_or_load_pages
  printf("innodb_shutdown call\n");
  printf("jesnk : time profiing of buf_dblwr_init_or_load_pages \n");
  printf("jesnk : buf_dblwr_init_or_load_pages_time : %llu\n",buf_dblwr_init_or_load_pages_time);
  printf("jesnk : buf_dblwr_init_or_load_pages_count : %llu\n",buf_dblwr_init_or_load_pages_count);
